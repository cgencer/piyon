   ...
   class element_gva_countdown{
      ...
      public function render_content( $attr = array(), $content = '' ){
         ...
         <div class="gsc-countdown <?php print implode($class, ' ') ?>">
            <div class="gva-countdown clearfix" data-countdown="countdown" data-date="<?php print $date ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>></div> 
         </div>
