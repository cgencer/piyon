...
interface ILTInterface extends ContentEntityInterface, EntityOwnerInterface {
  ...
  /**
   * Adds member to the members marked as have
   * received the email notification to the ILT.
   *
   * @param int $uid
   *   The user ID.
   *
  ...
  /**
   * Removes member from the members marked as have
   * received the email notification to the ILT.
   *
   * @param int $uid
   *   The user ID.
  ...
  /**
   * Returns ids of the members marked as have
   * received the email notification to the ILT.
   *
   * @return int[]
   *   Array of users IDs.
  ...
  /**
   * Set ids of members marked as have
   * received the email notification to the ILT.
   *
   * @param int[] $ids
   *   The users IDs.
  ...
  /**
   * Returns the members marked as have
   * received the email notification to the ILT.
   *
   * @return \Drupal\user\Entity\User[]
   *   Array of users.
