  ...
  public function getActivityTypes() {
    ...
    if (self::getPptConvertAllow()) {
      $ppt = [
        ...
        'name' => t('H5P PPT(X) Course Presentation'),
        'description' => t('This activity allows creation H5P Course Presentation content imported from PowerPoint files. Slides from PowerPoint presentation will be imported as images into H5P Course Presentation slider. Allowed file extensions are ppt/pptx.'),
      ];
    ...
    $this->array_unshift_assoc($types, 'external_package', [
      ...
      'name' => t('External package'),
      'description' => t('This activity allows to easily load training packages created externally. The following formats are supported: SCORM 1.2 and 2004, TinCan and H5P.'),
    ]);
