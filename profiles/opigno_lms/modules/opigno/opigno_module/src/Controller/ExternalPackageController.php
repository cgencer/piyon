  ...
  public static function convertPptSlidesToImages(File $file, $ppt_dir_real_path) {
    ...
    if (chdir($ppt_dir_real_path)) {
      ...
      if ($result) {
        ...
        // Convert to images.
//        exec("convert " . $path_info['filename'] . ".pdf -resize '1200x720^' -gravity Center -crop 1200x720+0+0 " . $path_info['filename'] . ".jpg");
//        exec("convert " . $path_info['filename'] . ".pdf -resize '1680x1050^' -gravity Center -crop 1680x1050+0+0 " . $path_info['filename'] . ".jpg");
