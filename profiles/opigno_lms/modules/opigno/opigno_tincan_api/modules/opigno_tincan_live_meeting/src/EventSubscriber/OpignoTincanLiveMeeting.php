...
class OpignoTincanLiveMeeting implements EventSubscriberInterface {
  ...
  /**
   * This method is called whenever the tincanLiveMeeting event is
   * dispatched.
   *
  ...
  public function tincanLiveMeeting(Event $event) {
    ...
    //    // Ensure if user is a member of meeting.
    //    $member_ids = $meeting->getMembersIds();
    //
    //    if (!in_array($this->user->id(), $member_ids)) {
    //      return;
    //    };
   ...
   *
   *   This function send tincan statements for Live meeting.
   *
