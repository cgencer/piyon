...
class DashboardForm extends FormBase {
   ...
   *   Render array.
   */
  protected function buildUsersPerDay($datetime, $lp_ids = NULL) {
   ...
   *   Render array.
   */
  protected function buildTrainingsProgress($datetime, $lp_ids = NULL) {
    $progress = 0;
    $completion = 0;
  ...
  public function access(AccountInterface $account) {
    ...
    if ($account->hasPermission('view global statistics')
      ...
      if ($lp_counts > 0) return AccessResultAllowed::allowed()->mergeCacheMaxAge(0);
      else return AccessResultAllowed::forbidden()->mergeCacheMaxAge(0);
    }
  }
